...
namespace Store.Tests.Handlers
{
    ...
    public class OrderHandlerTests
    {
        ...
        {
            // TODO: Implementar
            var customer = new CreateOrderCommand();
            customer.Customer = "11111111";
            customer.ZipCode = "12345678";
            customer.PromoCode = "12345678";
            customer.Items.Add(new CreateOrderItemCommand(Guid.NewGuid(), 1));
            customer.Items.Add(new CreateOrderItemCommand(Guid.NewGuid(), 1));
            customer.Validate();
